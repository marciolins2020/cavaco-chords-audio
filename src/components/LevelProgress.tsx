...
const levelIcons: Record<string, string> = {
  "Iniciante": "I", "Aprendiz": "II", "Intermediário": "III",
  "Avançado": "IV", "Profissional": "V", "Mestre": "VI",
};
...
export const LevelProgress = ({ level, progress, nextMilestone, totalXP, nextLevelXP }: LevelProgressProps) => {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <Badge variant="secondary" className="text-sm">Nível {levelNumber}</Badge>
              </div>
