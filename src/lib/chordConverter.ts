...
export const SUFFIX_MAP: Record<string, { quality: string; intervals: string[]; description: string }> = {
  ...
  "7(b13)": { quality: "7(b13)", intervals: ["1", "3", "5", "b7", "b13"], description: "Sétima com décima terceira bemol" },
  "7(b9)": { quality: "7(b9)", intervals: ["1", "3", "5", "b7", "b9"], description: "Sétima com nona bemol" },
  "7(b5)": { quality: "7(b5)", intervals: ["1", "3", "b5", "b7"], description: "Sétima com quinta bemol" },
  "7(#9)": { quality: "7(#9)", intervals: ["1", "3", "5", "b7", "#9"], description: "Sétima com nona sustenida" },
  "7(#11)": { quality: "7(#11)", intervals: ["1", "3", "5", "b7", "#11"], description: "Sétima com décima primeira sustenida" },
  "6(9)": { quality: "6(9)", intervals: ["1", "3", "5", "6", "9"], description: "Sexta com nona" },
  "6(7M)": { quality: "6(7M)", intervals: ["1", "3", "5", "6", "7"], description: "Sexta com sétima maior" },
  "6(7M/9)": { quality: "6(7M/9)", intervals: ["1", "3", "5", "6", "7", "9"], description: "Sexta com sétima maior e nona" },
  "6(#11)": { quality: "6(#11)", intervals: ["1", "3", "5", "6", "#11"], description: "Sexta com décima primeira sustenida" },
  "6(9/#11)": { quality: "6(9/#11)", intervals: ["1", "3", "5", "6", "9", "#11"], description: "Sexta com nona e décima primeira sustenida" },
  "7M(9)": { quality: "7M(9)", intervals: ["1", "3", "5", "7", "9"], description: "Sétima maior com nona" },
  "7M(#11)": { quality: "7M(#11)", intervals: ["1", "3", "5", "7", "#11"], description: "Sétima maior com décima primeira sustenida" },
  "7M(9/#11)": { quality: "7M(9/#11)", intervals: ["1", "3", "5", "7", "9", "#11"], description: "Sétima maior com nona e décima primeira sustenida" },
  "m7(9)": { quality: "m7(9)", intervals: ["1", "b3", "5", "b7", "9"], description: "Menor sétima com nona" },
  "m7(11)": { quality: "m7(11)", intervals: ["1", "b3", "5", "b7", "11"], description: "Menor sétima com décima primeira" },
  "m7(9/11)": { quality: "m7(9/11)", intervals: ["1", "b3", "5", "b7", "9", "11"], description: "Menor sétima com nona e décima primeira" },
  "7(b9/13)": { quality: "7(b9/13)", intervals: ["1", "3", "5", "b7", "b9", "13"], description: "Sétima com nona bemol e décima terceira" },
  "7(#11/13)": { quality: "7(#11/13)", intervals: ["1", "3", "5", "b7", "#11", "13"], description: "Sétima com décima primeira sustenida e décima terceira" },
  "7(#5/#9)": { quality: "7(#5/#9)", intervals: ["1", "3", "#5", "b7", "#9"], description: "Sétima com quinta e nona sustenidas" },
